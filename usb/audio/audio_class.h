...
/* keep mic wMaxPacketSize tight: usbd packet ram is 1280 bytes (usbbufs=1),
 * double-buffered mic+spk+feedback must all fit (296*2+232*2+4*2+ep0 = 1256) */
#define AUDIO_MIC_IN_MAXPACKET_SIZE      (AUDIO_SUPPORT_MAX_FREQ * AUDIO_MIC_CHANEL_NUM * (AUDIO_MIC_DEFAULT_BITW / 8) + 8)
